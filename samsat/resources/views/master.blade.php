    ...
    <div id="wrap">
       ...
       <div id="left">
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel">
                    <a href="{{url('/wajibpajak')}}" >
                        <i class="icon-table"></i> Kelola Wajib Pajak
                ...
                <li class="panel">
                    <a href="{{url('/kendaraan')}}" >
                        <i class="icon-table"></i> Kelola kendaraan
                ...
                <li class="panel">
                    <a href="{{url('/petugas')}}" >
                        <i class="icon-table"></i> Kelola petugas
                ...
                <li class="panel">
                    <a href="{{url('/stnk')}}" >
                        <i class="icon-table"></i> Kelola stnk
                ...
                <li class="panel">
                    <a href="{{url('/Plat')}}" >
                        <i class="icon-table"></i> Kelola Plat
                ...
                <li class="panel">
                    <a href="{{url('/bokb')}}" >
                        <i class="icon-table"></i> Kelola bokb
                ...
                <li class="panel">
                    <a href="{{url('/tagihanstnk')}}" >
                        <i class="icon-table"></i> Kelola tagihanstnk
